...
if __name__ == '__main__':
    ent = ["广州市新德成体育培训有限公司", "上海电影股份有限公司", "华为技术有限公司", "九次方大数据信息集团有限公司", "合肥电信电子通信研究所加工厂", "钦州市钦北区耀清养殖场", "北京缤果互动科技有限公司", "昆明琼云经贸有限公司南屏街服装店", "北京信中利益信股权投资中心（有限合伙）", "烟台明石达远投资中心（有限合伙）", "济南建华创业投资合伙企业（有限合伙）", "中投建华（湖南）创业投资合伙企业（有限合伙）"]
    ent = ["华泰证券股份有限公司哈尔滨民益街证券营业部", '南通大匠装饰装潢设计工程有限公司城区分公司']
    cli = PyClient()
    import time
    for i in ent:
        s = time.time()
