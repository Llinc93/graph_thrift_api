...
class Filter(object):
    ...
    files = [
        ...
        ('/home/csvdata/企业投资.csv', r'/home/neo4j_test/import/企业投资.csv', 'IPEES'),
        ('/home/csvdata/自然人投资.csv', r'/home/neo4j_test/import/自然人投资.csv', 'IPEER'),
        ...
        ('/home/csvdata/专利节点', r'/home/neo4j_test/import/专利节点.csv', 'PP'),
